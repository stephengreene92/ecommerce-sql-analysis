...
Relationships were used to build a clean analytical model.
...
Unique customers ≈ orders → low retention
Repeat purchase rate ~3%
Average order value ~137
...
Regional analysis
Delivery time vs repeat purchases
